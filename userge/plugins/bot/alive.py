...
async def send_alive_message(message: Message) -> None:
    ...
    if client.is_bot:
        ...
        caption += (
            ...
            f"\n⚡️  <a href='https://youtu.be/dQw4w9WgXcQ'><b>REPO</b></a>"

            "    <code>|</code>    "

            "👥  <a href='https://youtu.be/dQw4w9WgXcQ'><b>RINNEGAN</b></a>"
...
if userge.has_bot:
    ...
    async def alive_cb(_, c_q: CallbackQuery):
        ...
        if Config.HEROKU_APP and Config.RUN_DYNO_SAVER:
            ...
            alive_s += "⛽️ 𝗖𝗵𝗮𝗸𝗿𝗮 𝗦𝗮𝘃𝗲𝗿 :  ✅ 𝙴𝚗𝚊𝚋𝚕𝚎𝚍\n"
...
­<a href="https://telegra.ph/file/77bbb85f6cf4cc6842c5f.jpg"><b>𝑹𝑰𝑵𝑵𝑬𝑮𝑨𝑵</a> is on and Analysing.</b>
  ...
  🐍   <b>Orochimaru  :</b>    <code>v{versions.__python_version__}</code>
  🔥   <b>Perogram :</b>    <code>v{versions.__pyro_version__}</code>
  🧬   <b>Rinnegan :</b>    <code>v{get_version()}</code>
  👤   <b>Hokage :</b>    <code>{u_name}</code>
...
"""
    ...
    def alive_buttons() -> InlineKeyboardMarkup:
        ...
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton(text="✖️  RINNEGAN", url="https://telegra.ph/file/719cc9c6d5943af504092.jpg"),

                InlineKeyboardButton(text="⚡  REPO", url="https://youtu.be/dQw4w9WgXcQ"),
    ...
    def alive_default_imgs() -> str:
        ...
        alive_imgs = [
            ...
            "https://telegra.ph/file/4226c1567b185386d17e5.jpg",
